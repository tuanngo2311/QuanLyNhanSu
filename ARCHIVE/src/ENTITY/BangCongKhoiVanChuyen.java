 ...
 * @author Phong
 */
public class BangCongKhoiVanChuyen implements Serializable {

    String maNhanVien, hoTen, ngaySinh, luongCoBan, phuCap, phuCapKhac, thang, nam, soNgayCong, soNgayNghi, soGioLam, ghiChu;

    public BangCongKhoiVanChuyen(String maNhanVien, String luongCoBan, String phuCap, String phuCapKhac, String thang, String nam, String soNgayCong, String soNgayNghi, String soGioLam, String ghiChu) {
    ...
    public BangCongKhoiVanChuyen(String maNhanVien, String hoTen, String ngaySinh, String luongCoBan, String phuCap, String phuCapKhac, String thang, String nam, String soNgayCong, String soNgayNghi, String soGioLam) {
        this.maNhanVien = maNhanVien;
        this.hoTen = hoTen;
